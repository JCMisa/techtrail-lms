...
const HomeFooter = () => {
  return (
    <footer className="bg-dark-100 body-font">
          ...
          <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
            <div className="relative sm:w-64 w-40 sm:mr-4 mr-2">
              ...
              <input
                ...
                id="footer-field"
                name="footer-field"
                className="w-full bg-dark bg-opacity-40 rounded border border-dark focus:ring-2 focus:ring-primary focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
            <button className="inline-flex text-white bg-primary border-0 py-2 px-6 focus:outline-none hover:bg-primary-100 rounded">
              Submit
            </button>
      ...
      <div className="bg-dark-200 bg-opacity-75">
